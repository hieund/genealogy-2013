    ...
    public class GFUserRelations
    {
        ...
        public bool LoadByPrimaryKeys()
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    if (!this.IsDBNull(reader["OrderPosition"])) this.OrderPosition = Convert.ToInt32(reader["OrderPosition"]);
                    bolOK = true;
                }
                reader.Close();
            }
        ...
        public object Insert()
        {
            ...
            try
            {
                ...
                if (this.OrderPosition != int.MinValue) objData.AddParameter("@OrderPosition", this.OrderPosition);
        ...
        public object Update()
        {
            ...
            try
            {
                ...
                if (this.OrderPosition != int.MinValue) objData.AddParameter("@OrderPosition", this.OrderPosition);
                else objData.AddParameter("@OrderPosition", DBNull.Value);
